...
## 👨‍🍳 팀 소개
| [J002](https://github.com/moaikang) |[J077](https://github.com/pje1740) | [J138](https://github.com/kas136) | [S006](https://github.com/kgs19970120) | [S012](https://github.com/rile1036)|
| :--:| :--:|  :--:  | :--:  | :--:  |
...
> **강근우** 🧇 : 이유 있는 코드를 짜려고 노력하고, 개발을 즐기는 프론트엔드 개발자입니다.

> **박소현** 🥐 : 사용자 경험과 디자인 시스템에 진심이고 싶은 프론트 엔드 개발자입니다.

> **이민환** 🌭 : 개발이 재밌고 도전이 즐거운 웹 풀스택 개발자입니다.

> **김근수** 🍩 : 항상 새로운 도전거리를 찾아 해매는 iOS🍎 Lover 입니다

> **김영렬 🥯** : 배움에 굶주려 있는 애플러 입니다.
...
### API
| API | <img width= 50 src="https://i.imgur.com/2pLrZzB.png"> | <img width = 50 src="https://i.imgur.com/MJrv2aB.png">|
| :--: | :--: | :--: |
| **Link** | [파파고 번역 API](https://www.ncloud.com/product/aiService/papagoNmt) | [Clova API](https://www.ncloud.com/product/aiService/ocr) |
